...
public class Spawner : MonoBehaviour
{
    ...
    void Start()
    {
        Bounds _bottomBounds = _bottomWall.GetComponent<Renderer>().bounds;
        Bounds _topBounds = _topWall.GetComponent<Renderer>().bounds;
    ...
    private IEnumerator SpawnPrefab()
    {
        while (true)
        {
            ...
            while (Physics.CheckSphere(randomPos, _toSpawnPrefab.transform.localScale.x / 2))
